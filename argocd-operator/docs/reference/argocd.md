...
| Image     | `quay.io/argoprojlabs/argocd-image-updater` | The container image for Image Updater. This overrides the `ARGOCD_IMAGE_UPDATER_IMAGE` environment variable. |
