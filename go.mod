...
require (
	...
	github.com/argoproj-labs/argocd-operator v0.9.2-rc3
...
require (
	github.com/argoproj/argo-cd/v2 v2.11.1 // indirect
	...
	github.com/openshift/client-go v0.0.0-20240521210225-1a8f9bfc8107 // indirect
