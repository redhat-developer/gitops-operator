...
var _ = Describe("GitOps Operator Parallel E2E Tests", func() {
	...
	Context("1-096-validate_home_env_argocd_controller", func() {
		...
		It("verifies openshift-gitops app controller StatefulSet container has expected environment values", func() {

			By("verifying openshift-gitops-application-controller StatefulSet has the expected environment values")
