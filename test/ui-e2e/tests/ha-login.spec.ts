...
test.describe('HA Login Verification', () => {
  ...
  test.afterAll(async ({}, testInfo) => {
    ...
    try {
      ...
      //give operator time to reconcile the cr patch checking rollout status
      ...
      //wait for standard redis to roll out and become ready again
      ...
      //give the kubernetes service endpoints 5 seconds to stabilize routing
