...
| --info | string Array| A list of key-value pairs during sync process. These infos will be persisted in app. |
| --label | string Array| Sync only specific resources with a label. This option may be specified repeatedly. |
...
| --project | string Array| Sync apps that belong to the specified projects. This option may be specified repeatedly. |
