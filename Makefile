...
kuttl-e2e: manifests generate fmt vet ## Run operator e2e tests kubectl-kuttl test ./test/openshift-sequential --config ./test/openshift-sequential/kuttl-tests.yaml || true
